    ...
    events: [
      {
        ...
        places: ["西安北站", "西安永宁门B西南口", "西安市碑林区合能朱阙1号楼2单元3301室"],
      },
      {
        time: "16:30-20:30",
        title: "钟鼓楼夜景",
        desc: "从西后地坐 618/K618/32/218 到钟楼西。不开楼，开元商城门口拍照；19:30 左右看亮灯，结束后早点休息。",
        places: ["西安钟楼西公交站", "西安钟楼", "西安鼓楼", "西安开元商城钟楼店"],
      },
    ],
    foods: [
      {
  ...
  },
  {
    ...
    events: [
      ...
      },
      {
        ...
        places: ["西安雁塔西路东口公交站", "西安大雁塔文化休闲景区", "西安大雁塔北广场音乐喷泉"],
      },
      {
        time: "18:00-21:00",
        title: "大唐不夜城",
        desc: "18:30 出发；北广场东侧不倒翁小姐姐互动约 19:30。",
        places: ["西安大唐不夜城步行街", "西安大唐不夜城不倒翁演出点"],
      },
    ],
    foods: [
      {
    ...
    events: [
      {
        ...
        places: ["临潼秦始皇帝陵博物院", "临潼秦始皇兵马俑博物馆", "临潼秦始皇帝陵博物院丽山园"],
      },
      {
        time: "12:00-15:00",
        title: "午饭外卖＋午休",
      ...
      },
      {
        ...
        places: ["临潼华清宫景区", "临潼骊山国家森林公园"],
      },
      {
        time: "19:40-20:50",
        title: "《长恨歌》",
        desc: "华清宫景区演出，工作日建议提前 3 天预约。",
        places: ["临潼华清宫长恨歌演出", "临潼华清宫九龙湖"],
      },
    ],
    foods: [
      {
    ...
    events: [
      {
        ...
        places: ["西安城墙永宁门", "西安永宁门"],
      },
      {
        time: "15:00-17:00",
        title: "考古博物馆",
        desc: "下午去陕西考古博物馆，提前 3 天预约，每天早上 9 点。",
        places: ["西安陕西考古博物馆"],
      },
      {
        time: "17:30-20:00",
...
function amapSearch(keyword) {
  const scopedKeyword = /西安|临潼/.test(keyword) ? keyword : `${city} ${keyword}`;
  return `https://uri.amap.com/search?keyword=${encodeURIComponent(scopedKeyword)}&city=610100&src=mvp-xian-route`;
}
